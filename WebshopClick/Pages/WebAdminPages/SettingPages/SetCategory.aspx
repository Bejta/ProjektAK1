<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Shared/WebAdmin.Master" AutoEventWireup="true" CodeBehind="SetCategory.aspx.cs" Inherits="WebshopClick.Pages.WebAdminPages.SettingPages.SetCategory" %>
...
<%-- Detta visas då linjeuppgifter saknas i databasen. --%>
                ...
                <EditItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:Button CssClass="command" runat="server" CommandName="Update" Text="Spara" />
                            <asp:Button CssClass="command" runat="server" CommandName="Cancel" Text="Avbryt" CausesValidation="false" />
                        </td>
                    </tr>
                </EditItemTemplate>
            </asp:ListView>
